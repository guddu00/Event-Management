          ...
          events.map((event) => (
            <Link
              ...
              to={{
                ...
                state: { name: event.name }, // Passing name with id
              }}
            >
              <div className="p-4 overflow-hidden transition-all duration-300 ease-in-out border rounded-lg shadow-xl cursor-pointer bg-tertiary shadow-indigo-500/50 hover:bg-slate-300">
